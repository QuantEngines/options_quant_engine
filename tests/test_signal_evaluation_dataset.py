...
class SignalEvaluationDatasetTests(unittest.TestCase):
    ...
    def test_build_row_has_stable_primary_key_and_context(self):
        ...
        self.assertIn("runtime_quality", row_a["decision_quality_score_v1_available_components"])
        self.assertIn("provider_execution_block", row_a["decision_quality_score_v1_penalties"])
