...
def build_signal_evaluation_row(
    ...
    *,
    ...
    row = {
        ...
        "provider_analytics_status": trade.get("provider_analytics_status"),
        "provider_execution_status": trade.get("provider_execution_status"),
        "provider_direction_trust": trade.get("provider_direction_trust"),
        "provider_execution_trust": trade.get("provider_execution_trust"),
        "provider_quality_action": trade.get("provider_quality_action"),
        "provider_quality_note": trade.get("provider_quality_note"),
        "provider_quality_blocks_direction": trade.get("provider_quality_blocks_direction"),
        "provider_quality_blocks_execution": trade.get("provider_quality_blocks_execution"),
        "provider_quality_reasons": _join_list(trade.get("provider_quality_reasons")),
