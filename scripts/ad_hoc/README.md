...
This folder contains one-off or exploratory scripts that are useful for diagnostics
and historical investigations but are not part of the core production runtime.
