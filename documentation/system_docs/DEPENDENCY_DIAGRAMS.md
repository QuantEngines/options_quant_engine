...
subtitle: "Dependency Diagrams"
author: "Pramit Dutta"
date: "March 2026"
---

<div class="memo-cover">
<div class="cover-kicker">Visual Reference</div>
<h1 class="cover-title">Options Quant Engine</h1>
<div class="cover-subtitle">Dependency Diagrams</div>
<div class="cover-rule"></div>
<p class="cover-summary">Mermaid flowchart diagrams showing high-level architecture, folder dependencies, data-to-signal pipeline, research/tuning workflow, parameter workflow, and central-module relationships.</p>
<div class="cover-meta">
<div><span>Author</span>Pramit Dutta</div>
<div><span>Organization</span>Quant Engines</div>
<div><span>Date</span>March 2026</div>
<div><span>Document</span>Dependency Diagrams</div>
<div><span>Scope</span>Import relationships and data flow visualizations</div>
</div>
</div>
