...
The core implementation sits in `engine/trading_engine.py`, with most helper logic in `engine/trading_engine_support.py`.
...
The engine applies four important overlays after the core microstructure thesis is built.
