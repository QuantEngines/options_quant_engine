        ...
        with lower_right:
            _render_key_value_table(
                "Global Market Snapshot",
                {
                    ...
                    "dxy_change_24h": global_market_inputs.get("dxy_change_24h"),
                    "gift_nifty_change_24h": global_market_inputs.get("gift_nifty_change_24h"),
                    "sp500_change_24h": global_market_inputs.get("sp500_change_24h"),
                    "us10y_yield": global_market_inputs.get("us10y_yield"),
                    "us10y_change_bp": global_market_inputs.get("us10y_change_bp"),
                    "india_2y_yield": global_market_inputs.get("india_2y_yield"),
                    "india_5y_yield": global_market_inputs.get("india_5y_yield"),
                    "india_10y_yield": global_market_inputs.get("india_10y_yield"),
                    "india_30y_yield": global_market_inputs.get("india_30y_yield"),
                    "india_10y_change_bp": global_market_inputs.get("india_10y_change_bp"),
                    "india_2y10y_spread_bp": global_market_inputs.get("india_2y10y_spread_bp"),
                    "india_5y10y_spread_bp": global_market_inputs.get("india_5y10y_spread_bp"),
                    "india_us_10y_spread_bp": global_market_inputs.get("india_us_10y_spread_bp"),
                    "india_bond_yield_date": global_market_inputs.get("india_bond_yield_date"),
                    "india_bond_yield_source": global_market_inputs.get("india_bond_yield_source"),
                    "usdinr_change_24h": global_market_inputs.get("usdinr_change_24h"),
                    "fii_cash_net": global_market_inputs.get("fii_cash_net"),
                    "dii_cash_net": global_market_inputs.get("dii_cash_net"),
                    "fii_index_futures_net": global_market_inputs.get("fii_index_futures_net"),
                    "fii_index_options_net": global_market_inputs.get("fii_index_options_net"),
                    "institutional_flow_date": global_market_inputs.get("institutional_flow_date"),
                    "institutional_flow_source": global_market_inputs.get("institutional_flow_source"),
                    "institutional_flow_source_timestamp": global_market_inputs.get("institutional_flow_source_timestamp"),
