...
SIGNAL_DATASET_COLUMNS = [
    ...
    "multi_source_primary_source",
    "multi_source_requested_sources",
    "multi_source_successful_sources",
    "multi_source_failed_sources",
    "multi_source_provider_records_json",
    "multi_source_saved_chain_paths_json",
    "mode",
    "parameter_pack_name",
    ...
    "price_structure_vwap",
    "price_structure_vwap_source",
    "price_structure_twap_proxy",
    "price_structure_twap_proxy_source",
    "spot_vs_vwap_state",
    "spot_vs_vwap_distance_pts",
    "spot_vs_vwap_distance_pct",
    "spot_vs_twap_proxy_state",
    "spot_vs_twap_proxy_distance_pts",
    "spot_vs_twap_proxy_distance_pct",
    "price_structure_range_position_pct",
    "prior_session_ohlc_available",
    "prior_session_high",
    "prior_session_low",
    "prior_session_close",
    "prior_session_date",
    "prior_session_ohlc_source",
    "classic_pivot_available",
    "classic_pivot",
    "cpr_bc",
    "cpr_tc",
    "cpr_lower",
    ...
    "pivot_s3",
    "spot_vs_pivot_state",
    "spot_vs_pivot_distance_pts",
    "spot_vs_pivot_distance_pct",
    "spot_vs_cpr_state",
    "spot_vs_cpr_lower_distance_pts",
    "spot_vs_cpr_lower_distance_pct",
    "spot_vs_cpr_upper_distance_pts",
    "spot_vs_cpr_upper_distance_pct",
    "nearest_price_structure_anchor_label",
    "nearest_price_structure_anchor_side",
    "nearest_price_structure_anchor_level",
    "nearest_price_structure_anchor_distance_pts",
    "nearest_price_structure_anchor_distance_pct",
    "opening_range_5m_status",
    "opening_range_5m_row_count",
    "opening_range_5m_sample_quality",
    "opening_range_5m_high",
    "opening_range_5m_low",
    "opening_range_5m_width_pts",
    "opening_range_5m_state",
    "opening_range_15m_status",
    "opening_range_15m_row_count",
    "opening_range_15m_sample_quality",
    "opening_range_15m_high",
    "opening_range_15m_low",
    "opening_range_15m_width_pts",
    "opening_range_15m_state",
    "opening_range_30m_status",
    "opening_range_30m_row_count",
    "opening_range_30m_sample_quality",
    "opening_range_30m_high",
    "opening_range_30m_low",
    "opening_range_30m_width_pts",
    "opening_range_30m_state",
    "price_level_confluence_state",
    "price_level_confluence_score",
    "price_level_confluence_source_count",
    "price_level_confluence_level_count",
    "nearest_confluence_level",
    "nearest_confluence_distance_pts",
    "nearest_confluence_distance_pct",
    "nearest_confluence_sources",
    "nearest_confluence_labels",
    "price_structure_acceptance_state",
    "price_structure_acceptance_basis",
    ...
    "decision_quality_score_v1_available_components",
    "decision_quality_score_v1_missing_components",
    ...
    "runtime_composite_supplement_rule",
    "runtime_composite_supplement_candidate_adjustment",
    "runtime_composite_supplement_score_adjustment",
    "runtime_composite_supplement_reason",
    "runtime_composite_supplement_base_score",
    "runtime_composite_supplement_adjusted_score",
    "runtime_composite_supplement_components",
    ...
    "global_risk_regime_score",
    "global_risk_risk_off_pressure",
    "global_risk_risk_on_support",
    "oil_change_24h",
    "oil_shock_score",
    ...
    "india_bond_yield_date",
    "india_bond_yield_source",
    "india_bond_yield_source_timestamp",
    "india_bond_yield_staleness_days",
    "india_bond_yield_data_available",
    ...
    "institutional_flow_date",
    "institutional_flow_source",
    "institutional_flow_source_timestamp",
    "institutional_flow_staleness_days",
    "institutional_flow_data_available",
