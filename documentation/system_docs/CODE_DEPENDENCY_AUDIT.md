...
subtitle: "Code Dependency Audit"
author: "Pramit Dutta"
date: "March 2026"
---

<div class="memo-cover">
<div class="cover-kicker">Dependency Analysis</div>
<h1 class="cover-title">Options Quant Engine</h1>
<div class="cover-subtitle">Code Dependency Audit</div>
<div class="cover-rule"></div>
<p class="cover-summary">Reconstructed dependency audit of 154 non-test Python modules showing folder-level couplings, central modules, and architectural strengths and weaknesses.</p>
<div class="cover-meta">
<div><span>Author</span>Pramit Dutta</div>
<div><span>Organization</span>Quant Engines</div>
<div><span>Date</span>March 2026</div>
<div><span>Document</span>Dependency Audit</div>
<div><span>Scope</span>Module graph, folder-level dependencies, coupling hotspots</div>
</div>
</div>
