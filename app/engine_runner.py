    ...
    *,
    ...
    try:
        if use_promotion_state:
            ...
            authoritative_pack_name = authoritative_pack_name or promotion_context.get("live_pack")
            shadow_pack_name = shadow_pack_name or promotion_context.get("shadow_pack")
        ...
        result_payload = {
            ...
            "trade": trade,
            "authoritative_parameter_pack": authoritative_eval["parameter_pack_name"],
        ...
        if shadow_pack_name:
            shadow_eval = _evaluate_snapshot_for_pack(
